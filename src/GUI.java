        ...
        public void paintComponent(Graphics g){
            ...
            for(int i = 0; i < 16; i++){
                for (int j = 0; j < 9; j++ ){
                    ...
                    if(mx >= spacing + i * 80 && mx < i * 80 + 80 - spacing && my >= spacing + j * 80 + 80 + 26 && my < spacing  + j * 80 + 186 - spacing){
                    ...
                    if(flagged[i][j] == true){
                        g.setColor(Color.black);
                        g.fillRect(i*80 +32+5, j*80 +95 +5, 5, 40);
            ...
            g.drawRect(flaggerY +17, flaggerY +16, 18, 13);
